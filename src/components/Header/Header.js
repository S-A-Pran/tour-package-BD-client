            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                ...
                }
                {
                    !user?.email ? <Nav.Link className='text-white link' as={Link} to='/login'>Login</Nav.Link> : <div className='d-flex justify-content-between align-items-center'>
                        <div className='d-flex mx-2 align-items-center bg-success rounded-pill'>
                        ...
                        <button onClick={logOut} className='btn btn-dark rounded-pill' w-50>Logout {logout}</button>
                    </div>
                }
                </Nav>
            </Navbar.Collapse>
